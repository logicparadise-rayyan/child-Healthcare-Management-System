...
<br>
<h1 class="fr-head-color">Disease Detection</h1>
...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class=" input-group mb-2">
                <input type="search" id="search" class="form-control fr-head-color bg-compo form-control-border" placeholder="Search Disease here...">
                <div class="input-group-append">
                    <button type="button" class="btn btn-sm border-0 bg-compo fr-head-color border-bottom btn-default">
    ...
    <?php 
        $package = $conn->query("SELECT * FROM `disease_detection` where `status` = 1 order by `name` asc");
    ...
    <div class="text-decoration-none bg-compo list-group-item rounded-0 package-item">
        ...
        <div class="collapse fr-head-color" id="package_<?= $row['id'] ?>">
    ...
    <?php endif; ?>
        <div id="no_result" style="display:none"><center><span class="text-muted">No Disease Listed Yet.</span></center></div>
    </div>
</div>
<script>
    $(function(){
