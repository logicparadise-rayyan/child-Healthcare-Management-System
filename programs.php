...
<br>
<h1 class="fr-head-color">Our Services/Programs</h1>
<hr class="border-navy bg-navy">
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="input-group mb-2">
                <input type="search" id="search" class="form-control form-control-border bg-compo fr-color" placeholder="Search Program here...">
                <div  class="input-group-append">
                    <button type="button" class="btn btn-sm border-0 border-bottom btn-default bg-compo">
    ...
    <div class="text-decoration-none bg-compo  list-group-item rounded-0 package-item">
        ...
        <div class="collapse fr-color" id="package_<?= $row['id'] ?>">
            ...
            <p class="mx-3 fr-head-color"><?= html_entity_decode($row['description']) ?></p>
        </div>
    </div>
    <?php endwhile; ?>
