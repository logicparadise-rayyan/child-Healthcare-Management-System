    ...
    <div class="container-fluid">
        <div class="card card-outline card-info shadow rounded-0">
            <div class="card-header">
                <h4 class="card-title"><?= isset($id) ? "Add New Doctor" : "Manage Doctor"; ?></h4>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                    <form action="" id="doctor-form">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <center>
                                        <img src="<?= validate_image(isset($id) ? "uploads/doctors/{$id}.png" : "").(isset($date_updated) ? "?v=".strtotime($date_updated) : "") ?>" alt="Doctor Image" id="cimg" class="bg-gradient-dark">
                                    </center>
                                </div>
                            </div>
                        </fieldset>
            ...
            <div class="card-footer">
                <div class="text-center">
                    <button class="btn btn-flat btn-primary" form="doctor-form"><i class="fa fa-save"></i> Save</button>
                    <a href="./?page=Doctor" class="btn btn-flat btn-light border"><i class="fa fa-angle-left"></i> Cancel</a>
                </div>
            </div>
        </div>
    </div>
