...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-gradient-dark">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>enroller" class="brand-link bg-transparent text-sm shadow-sm">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>enroller/?page=babysitters" class="nav-link nav-babysitters">
                       ...
                       <li class="nav-item">
                           <a href="<?php echo base_url ?>enroller/?page=Doctor" class="nav-link nav-Doctor">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>enroller/?page=vaccination" class="nav-link nav-vaccination">
                       ...
                       <li class="nav-item">
                           <a href="<?php echo base_url ?>enroller/?page=user" class="nav-link nav-user">
