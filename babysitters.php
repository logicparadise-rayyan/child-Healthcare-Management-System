...
<div class="content py-3">
    <div class="container-fluid">
        <h1 class="fr-head-color"><b>Our Babysitters</b></h1>
        <hr class="bg-navy">
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="input-group mb-2">
                    <input type="search" id="search" class="form-control form-control-border bg-compo fr-head-color" placeholder="Search Babysitter here...">
