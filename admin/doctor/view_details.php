...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3">
            <center>
                <img id="bs-img-modal" src="<?= validate_image(isset($id) ? "uploads/doctors/{$id}.png" : "").(isset($date_updated) ? "?v=".strtotime($date_updated) : "") ?>" alt="BS Image" class="bg-gradient-dark">
            </center>
        </div>
        <div class="col-md-9">
            <dl>
