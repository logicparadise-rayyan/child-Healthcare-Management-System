                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=enrollment" class="nav-link nav-enrollment">
                       ...
                       <li class="nav-item">
                           <a href="<?php echo base_url ?>admin/?page=Doctor" class="nav-link nav-Doctor">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=babysitters" class="nav-link nav-babysitters">
                       ...
                       <li class="nav-item dropdown">
                           <a href="<?php echo base_url ?>admin/?page=disease-detection" class="nav-link nav-disease-detection">
                       ...
                       <li class="nav-item dropdown">
                           <a href="<?php echo base_url ?>admin/?page=government-schemes" class="nav-link nav-government-schemes">
                       ...
                       <li class="nav-item dropdown">
                           <a href="<?php echo base_url ?>admin/?page=mealplanechart" class="nav-link nav-government-schemes">
